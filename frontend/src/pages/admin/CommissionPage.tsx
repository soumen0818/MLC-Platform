...
export default function CommissionPage() {
  return (
    <div className="flex flex-col gap-6 font-sans">
      <div>
        <h1 className="text-[22px] font-bold text-text-primary tracking-tight m-0">Commission Config</h1>
        <p className="text-[14px] text-text-secondary mt-1">Configure commission rates and distribution rules.</p>
      </div>
      <div className="card p-10 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-[13px] text-text-secondary max-w-[360px] mx-auto leading-relaxed">
            The Commission Config module is currently being finalized. Check back soon for updates.
          </p>
        </div>
      </div>
    </div>
