  ...
  return (
    <div className="flex flex-col gap-6 font-sans">
      <div>
        ...
        <p className="text-[14px] text-text-secondary mt-1">Transfer funds to your network members.</p>
      </div>
      <div className="card p-10 flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-[13px] text-text-secondary max-w-[360px] mx-auto leading-relaxed">
            The Fund Transfer module is currently being finalized. Check back soon for updates.
          </p>
        </div>
      </div>
    </div>
